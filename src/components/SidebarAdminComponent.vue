...
<template>
    <nav class="sidebar locked">
        ...
        <div class="menu_items">
            ...
            <li class="item">
                <router-link to="/admin/add/Professor" class="link flex">
                    <i class="bx bxs-magic-wand"></i>
                    <span>Add Professor</span>
                </router-link>
            </li>
            <li class="item">
                <router-link to="/admin/list/Professor" class="link flex">
                    <i class="bx bx-folder"></i>
                    <span>List Of Professors</span>
                </router-link>
            </li>
            </ul>
            ...
            <li class="item">
                <router-link to="/admin/add/Participant" class="link flex">
                    <i class="bx bxs-magic-wand"></i>
                    <span>Add Participant</span>
                </router-link>
            </li>
            <li class="item">
                <router-link to="/admin/list/Participant" class="link flex">
                    <i class="bx bx-folder"></i>

                ...
                <div class="edu-grid-sorting bg-fw">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <p class="mb-0">Showing 1-6 of 54 results</p>
                        </div>
                        <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single-courses-box mb-25 box-shadow-2">
                                    <div class="image mb-20 position-relative">
                                        <a href="course-details.html" class="d-block">
                                                <img src="./assets/img/all-img/course-5.png" alt="image">
                                            </a>
                                        <div class="cr-option">
                                            <a href="author.html"><i class="ri-heart-fill"></i></a>
                                            <a href="author.html"><i class="ri-shopping-basket-fill"></i></a>
                                    ...
                                    <div class="content">
                                        <div class="meta-info mb-20 d-flex align-items-center justify-content-between">
                                            <div class="author d-flex align-items-center">
                                                <img src="./assets/img/all-img/user-5.png" alt="image">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single-courses-box mb-25 box-shadow-2">
                                    <div class="image mb-20 position-relative">
                                        <a href="course-details.html" class="d-block">
                                                <img src="./assets/img/all-img/course-6.png" alt="image">
                                            </a>
                                        <div class="cr-option">
                                            <a href="author.html"><i class="ri-heart-fill"></i></a>
                                            <a href="author.html"><i class="ri-shopping-basket-fill"></i></a>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single-courses-box mb-25 box-shadow-2">
                                    <div class="image mb-20 position-relative">
                                        <a href="course-details.html" class="d-block">
                                                <img src="./assets/img/all-img/course-7.png" alt="image">
                                            </a>
                                        <div class="cr-option">
                                            <a href="author.html"><i class="ri-heart-fill"></i></a>
                                            <a href="author.html"><i class="ri-shopping-basket-fill"></i></a>
                                    ...
                                    <div class="content">
                                        <div class="meta-info mb-20 d-flex align-items-center justify-content-between">
                                            <div class="author d-flex align-items-center">
                                                <img src="./assets/img/all-img/user6.png" alt="image">
                                                <span>Wade Warren</span>
                                            </div>
                                            <div class="cr-price">
                                                <h5 class="fs-16"><span class="price">$100/</span> <span class="old-price">$400</span></h5>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single-courses-box mb-25 box-shadow-2">
                                    <div class="image mb-20 position-relative">
                                        <a href="course-details.html" class="d-block">
                                                <img src="./assets/img/all-img/course-8.png" alt="image">
                                            </a>
                                        <div class="cr-option">
                                            <a href="author.html"><i class="ri-heart-fill"></i></a>
                                            <a href="author.html"><i class="ri-shopping-basket-fill"></i></a>
                                    ...
                                    <div class="content">
                                        <div class="meta-info mb-20 d-flex align-items-center justify-content-between">
                                            <div class="author d-flex align-items-center">
                                                <img src="./assets/img/all-img/user-8.png" alt="image">
                                                <span>Robert Fox</span>
                                            </div>
                                            <div class="cr-price">
                                                <h5 class="fs-16"><span class="price">$100/</span> <span class="old-price">$400</span></h5>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="categories.html">
                                                            <p>Business Consulting</p> <span>(15)</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="categories.html">
                                                            <p>Tax Consulting</p> <span>(20)</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="categories.html">
                                                            <p>Art & Design</p> <span>(10)</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="categories.html">
                                                            <p>Tax Consulting</p> <span>(20)</span></a>
                                                    ...
                                                    <li>
                                                        <a href="categories.html">
                                                            <p>Technology</p> <span>(17)</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="categories.html">
                                                            <p>Development</p> <span>(08)</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="categories.html">
                                                            <p>Impact of Education</p> <span>(03)</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>

                      ...
                      <div class="col-lg-4 col-sm-6 mix-target Business Design">
                          <div class="single-courses-box mb-25 box-shadow-2">
                              <div class="image mb-20 position-relative">
                                  ...
                                  <div class="cr-option">
                                      <a href="courses-list.html"><i class="ri-heart-fill"></i></a>
                                      <a href="courses-list.html"><i class="ri-shopping-basket-fill"></i></a>
                                  </div>
                                  <div class="cr-tag">
                              ...
                              <div class="content">
                                  ...
                                  <h3 class="mb-15 fs-20"><a href="course-details.html">Full web Designing Course with 42 web Template.</a></h3>
                      ...
                      <div class="col-lg-4 col-sm-6 mix-target Business Development">
                          <div class="single-courses-box mb-25 box-shadow-2">
                              ...
                              <div class="content">
                                  <div class="meta-info mb-20 d-flex align-items-center justify-content-between">
                                      <div class="author d-flex align-items-center">
                                          <img src="../assets/img/all-img/user-6.png" alt="image">
...
.grid-short .accordion-button::after {
    /* background-image: url(../asstes/img/icon/down-arrow.png); */
...
.single-provides-info {
    ...
    /* background-image: url(../asstes/img/all-img/single-provides-info.jpg); */
}
...
.single-course-sidebar .course-widget .course-video {
    position: relative;
    /* background-image: url(../asstes/img/all-img/course-promo.png); */
    background-size: cover;
    background-repeat: no-repeat;
    padding: 60px 0;
}
